...
| **Run ID** | 22438919234 |
| **Result** | pass |
| **Commit** | fd579a87608f82c1490c668c18a6aa69c3823d39 |
| **Ref** | refs/heads/dev |
| **Event** | push |
| **Actor** | pkinerd |
...
test-reports/bwpm-tests.xcresult/Data/ (13068 files)
...
<coverage line-rate="0.8125494203374573" branch-rate="1.0" lines-covered="200382" lines-valid="246609" timestamp="1772104387.134" version="diff_coverage 0.1" complexity="0.0" branches-valid="1.0" branches-covered="1.0">
    <sources>
        <source>.</source>
```
