...
| **Run ID** | 22274126415 |
| **Result** | pass |
| **Commit** | 6796115aad3326e1272c0f6ea5ea1b8a7b5db148 |
| **Ref** | refs/heads/dev |
| **Event** | push |
| **Actor** | pkinerd |
...
test-reports/bwpm-tests.xcresult/Data/ (13058 files)
...
<coverage line-rate="0.8511034808470445" branch-rate="1.0" lines-covered="200034" lines-valid="235029" timestamp="1771752167.612" version="diff_coverage 0.1" complexity="0.0" branches-valid="1.0" branches-covered="1.0">
    <sources>
        <source>.</source>
```
