...
| **Run ID** | 22437590015 |
| **Result** | pass |
| **Commit** | deed73f82c7f9c1093fa03adeab62f60c7949979 |
| **Ref** | refs/heads/dev |
| **Event** | push |
| **Actor** | pkinerd |
...
test-reports/bwpm-tests.xcresult/Data/ (13066 files)
...
<coverage line-rate="0.8516176764477025" branch-rate="1.0" lines-covered="200286" lines-valid="235183" timestamp="1772102037.772" version="diff_coverage 0.1" complexity="0.0" branches-valid="1.0" branches-covered="1.0">
    <sources>
        <source>.</source>
```
