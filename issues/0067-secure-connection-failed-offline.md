---
id: 67
title: "[SEC-1] secureConnectionFailed in offline triggers"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
*Source: `ActionPlans/Resolved/AP-SEC1_SecureConnectionFailedClassification.md`*
...
URLError extension deleted; all API errors now trigger offline save via denylist pattern. Commit: `e13aefe`.
