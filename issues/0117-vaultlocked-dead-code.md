---
id: 117
title: "[RES-vaultLocked] .vaultLocked error case defined but never thrown"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
**Resolution:** Removed dead `.vaultLocked` case. AP-68 (Resolved)

**Disposition:** Resolved / Superseded

## Action Plan

*Source: `ActionPlans/Resolved/AP-68_VaultLockedDeadCode.md`*
...
Removed `.vaultLocked` case from `OfflineSyncError` enum and associated test.
