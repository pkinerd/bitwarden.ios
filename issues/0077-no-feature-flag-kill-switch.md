---
id: 77
title: "[S8] No feature flag / kill switch"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
**Resolution:** Two server-controlled flags added.
...
Two server-controlled feature flags added: `.offlineSyncEnableResolution` and `.offlineSyncEnableOfflineChanges`, both defaulting to `false`.
