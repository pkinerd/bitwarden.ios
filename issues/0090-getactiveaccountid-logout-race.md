---
id: 90
title: "[R2-VR-6] getActiveAccountId() in handleOfflineDelete could throw on logout"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
**Resolution:** Sub-millisecond window; UI lifecycle prevents logout during active operation. AP-R2-VR-6 (Resolved)

**Disposition:** Resolved / Superseded

## Action Plan

*Source: `ActionPlans/Resolved/AP-R2-VR-6_GetActiveAccountIdInDelete.md`*
...
Hypothetical — sub-millisecond window; state service returns stored state, not auth state; UI lifecycle prevents logout during active operation.
