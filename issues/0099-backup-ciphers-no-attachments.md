---
id: 99
title: "[RES-7] Backup ciphers do not include attachments"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
**Resolution:** Accepted — attachment duplication disproportionately complex. AP-RES7 (Resolved)

**Disposition:** Resolved / Superseded

## Action Plan

*Source: `ActionPlans/Resolved/AP-RES7_BackupCiphersLackAttachments.md`*
...
Accepted design decision — attachment duplication requires download/re-encrypt/upload per attachment, disproportionately complex for sync resolution; primary cipher attachments preserved.
