---
id: 72
title: "[VI-1] Offline-created cipher infinite spinner"
status: closed
created: 2026-02-21
author: claude
labels: [bug]
...
**Resolution:** `CipherView.withId()` replaces `Cipher.withTemporaryId()`. Commit: `3f7240a`

**Disposition:** Resolved / Superseded

## Action Plan

*Source: `ActionPlans/Resolved/AP-VI1_OfflineCreatedCipherViewFailure.md`*
...
Root cause fixed: `Cipher.withTemporaryId()` (producing `data: nil`) replaced by `CipherView.withId()` operating before encryption. Commit: `3f7240a`. Fallback fetch added as defense-in-depth (PR #31).
