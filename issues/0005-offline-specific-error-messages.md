...
Archive, unarchive, restore, and collection assignment show generic network errors when attempted offline. **Recommended:** Add `OfflineSyncError.operationNotSupportedOffline` and catch blocks in 4 methods. Low effort (~20-30 lines), could ship in initial release.
