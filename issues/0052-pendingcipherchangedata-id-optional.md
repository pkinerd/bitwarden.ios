...
*Source: `ActionPlans/Accepted/AP-PCDS1_IdOptionalRequiredMismatch.md`*
...
`PendingCipherChangeData.id` optional in Swift but required in Core Data schema. Core Data `@NSManaged` limitation, not a design flaw.
